...
// --- Configure per-run ---
const pdfPath = path.resolve(__dirname, '../../SAS AP Supplements/ap-biology-chief-reader-recommendations.pdf');
const targetCedFile = path.resolve(__dirname, '../src/constants/extracted-ceds/ap-biology.json');
const courseName = 'AP Biology';
// --------------------------
...
async function run() {
  ...
  const uploadResult = await ai.files.upload({
    ...
    displayName: 'chief-reader-notes',
  });
